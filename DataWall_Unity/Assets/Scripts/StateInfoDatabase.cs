...
public class StateInfoDatabase : MonoBehaviour {
	...
	public void PopulatePresets() {
		...
		for (var i = 0; i < System.Enum.GetNames(typeof(StateName)).Length; i++) {
			...
			for (var j = 0; j < System.Enum.GetNames(typeof(DataYear)).Length; j++) {
		...
		for (var i = 0; i < System.Enum.GetNames(typeof(DataYear)).Length; i++) {
